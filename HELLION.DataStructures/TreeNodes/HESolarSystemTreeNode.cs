...
namespace HELLION.DataStructures
{
    ...
    public class HESolarSystemTreeNode : HETreeNode
    {
        ...
        public double SemiMajorAxis
        {
            ...
            {
                if (OrbitData == null) throw new NullReferenceException();
                else return OrbitData.SemiMajorAxis; 
            }
        }
        ...
        public double Inclination
        {
            ...
            {
                if (OrbitData == null) throw new NullReferenceException();
                else return OrbitData.Inclination;
            }
        }
        ...
        public HESolarSystemTreeNode(HEGameDataTreeNode gameDataNodeToLink, HETreeNodeType nodeType) : base()
        {
            ...
            else
            {
                ...
                LinkedGameDataNode = gameDataNodeToLink;

                // Cast the LinkedGameDataNode.Tag field in to a JObject.
                JObject linkedGameDataJson = (JObject)LinkedGameDataNode.Tag;
